...
class ConvLSTMCell_v2(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim_pre, hidden_dim_cur, kernel_size, bias):
        """
        ...
        self.hidden_dim_pre = hidden_dim_pre
        self.hidden_dim_cur = hidden_dim_cur
        ...
        self.conv = nn.Conv2d(in_channels=self.input_dim + self.hidden_dim_pre,
                              out_channels=4 * self.hidden_dim_cur,
    ...
    def forward(self, input_tensor, cur_state):
        ...
        cc_i, cc_f, cc_o, cc_g = torch.split(combined_conv, self.hidden_dim_cur, dim=1)
...
class ConvLSTM(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
        ...
        # make sure taht both 'kernel_size' and 'hidden_dim' are lists having len == num_layers
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if not self.batch_first:
            # (t, b, c, h, w) -> (b, t, c, h ,w)
            input_tenor = input_tensor.permute(1, 0, 2, 3, 4)
